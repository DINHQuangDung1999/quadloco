...
VLA_CHECKPOINT="${VLA_CHECKPOINT:-${QUADLOCO_ROOT}/outputs/pi05_quadloco_rgbd_direct_small_1epoch_pairwise_add_16x16_direct_velocity_state42_no_velocity_command/checkpoints/last/pretrained_model}"
LOCOMOTION_CHECKPOINT="${LOCOMOTION_CHECKPOINT:-${QUADLOCO_ROOT}/ckpt/model_999.pt}"
TASK="${TASK:-Unitree-Go2-Quadloco-ManagerBased-Rough-Direct-v0}"
